...
class LinearReceiver():
    ...
    def reconstruct_image(self, source_WF, wavelength, pattern_title = "Reconstructed Source Region"):
        ...
        self.reconstructed_wavefield = Wave_Field(source_WF.radius, source_WF.sample_spacing)
        self.reconstructed_wavefield.generate_composite_wave_field_pattern(source_WF.receiver_coordinates, wavelength,
                                                                           wave_field_at_receiver, plot=False)
